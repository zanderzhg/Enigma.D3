...
{
    public class MapMarkerAcdGreaterRiftSoul : MapMarkerAcd
    {
        private static Brush _borderBrush;
        private static Brush _fillBrush;

        public MapMarkerAcdGreaterRiftSoul(ACD acd, Func<ACD, bool> isValid)
            : base(acd, isValid) { }
        ...
        public override object CreateControl()
        {
            ...
            {
                _borderBrush = ControlHelper.CreateAnimatedBrush(Colors.Red, Colors.Purple, 0.5);
